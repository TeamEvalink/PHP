        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              <h3 class="page-header"><a href="<?php echo site_url("/sysclient/index")?>">潜在客户</a></h3>
              <button type="button" class="btn btn-success btn-sm" onclick="javascript:window.location.href='<?php echo site_url("/sysclient/addClient")?>'">新增潜在客户</button>
                ...
                <table class="table table-striped table-condensed">
                  ...
                  <tbody id="advertListTbody" >
                    ...
                    <tr>
                      ...
                      <button type="button" class="btn btn-primary btn-sm" onclick="javascript:window.location.href='<?php echo site_url("/sysclient/share/$v->client_id")?>'" >分配</button>                         
