			      	...
			      	<form class="form-horizontal" id="clientedit" method="post" enctype=”multipart/form-data”>
				      	...
				      	<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="contract_no"  type="text" style="width:60%" class="form-control" id="contract_no" placeholder="合同编号" value="">
						   		</div>
						  	</div>
				      	</div>
				      	...
				      	<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="contract_money"  type="text" style="width:60%" class="form-control" id="contract_money" placeholder="合同金额" value="">
						   		</div>
						  	</div>
				      	</div>				      	
				      	...
				      	<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="sign_date"  type="text" style="width:60%" class="form-control" id="sign_date" placeholder="签约日期" value="">
						   		</div>
						  	</div>
				      	</div>
      					...
      					<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="contract_limit"  type="text" style="width:60%" class="form-control" id="contract_limit" placeholder="合同期限" value="">
						   		</div>
						  	</div>
				      	</div>
				      	...
				      	<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="class_num"  type="text" style="width:60%" class="form-control" id="class_num" placeholder="有效课时数" value="">
						   		</div>
						  	</div>
				      	</div>
					    ...
					    <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-primary" onclick="addconstract()">添加</button>
					    </div>
			      	</form>
				</div>
	        </div>
	...
	function addconstract(){	
		$.post("/sysconstract/addActive", 
			...
			function(data){			
				...
				if (data.status==1) {
					alert(data.info);
					window.location.href="/sysconstract/clientConstract/<?php echo $client_id; ?>";
				}
