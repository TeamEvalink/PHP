...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>修改账户信息|系统设置|后台管理系统</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header"><a href="<?php echo site_url("/sysuser")?>">账户修改</a></h3>
  <div id="form_box">       
      ...
      <div class="modal-body">
	       <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input name="account"  type="text" class="form-control" id="account" placeholder="账户名称" value="<?php echo $info->account; ?>">
		    </div>
		  </div>
		  
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">账户密码</label>
		    <div class="col-sm-10">
		      <input name="PASSWORD"  type="text" class="form-control" id="PASSWORD" placeholder="不修改则不填写" value="">
		    </div>
		  </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input name="user_name"  type="text" class="form-control" id="user_name" placeholder="员工姓名" value="<?php echo $info->user_name; ?>">
        </div>
      </div>
		    ...
		    <div class="col-sm-10">
		           <select name="u_group_id" id="u_group_id" class="form-control"  >
						...
						foreach ($qxinfo as $key => $val) { ?>
							...
							<option value="<?php echo $val->id; ?>" <?php if($val->id==$info->u_group_id){echo "selected";}?>><?php echo $val->name; ?></option>
