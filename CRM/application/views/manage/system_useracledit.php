...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>修改用户组权限|系统设置|后台管理系统</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header"><a href="<?php echo site_url("/sysacl")?>">账户权限修改</a></h3>
  <div id="form_box">       
      <form class="form-horizontal" id="useracledit" method="post" enctype=”multipart/form-data”>
      <div class="modal-body">
	       <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">用户组名称：</label>
		    <div class="col-sm-10">
		      <input name="name"  type="text" class="form-control" id="name" placeholder="用户组名称" value="<?php echo $info->name; ?>">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input name="intro"  type="text" class="form-control" id="intro" placeholder="用户组介绍" value="<?php echo $info->intro; ?>">
		    </div>
		  </div>
      ...
      <?php if($keyname != "data"){ ?>
		   <div class="form-group">
		    ...
		    <div class="col-sm-10">
               ...
               <input data="fa<?php echo $ke;?>_son" type="checkbox" name="model[<?php echo $fmodel;?>][]" <?php if(@is_array($info->controller[$fmodel]) && @array_keys($info->controller[$fmodel],$itemkey)) echo 'checked="checked"'; ?> value="<?php echo $itemkey;?>" id="<?php echo $fmodel;?><?php echo $itemkey;?>">
      ...
      <?php }?>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onclick="updateuseracl()">修改</button>
	      </div>
      </form>
</div>
        </div>
