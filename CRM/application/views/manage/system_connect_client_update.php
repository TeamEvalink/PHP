...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>更新联系结果|系统设置|后台管理系统</title>
    ...
    <div class="container-fluid">
		...
		<?php $this->load->view('manage/menu');?>
	        ...
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	          	<h3 class="page-header"><a href="<?php echo site_url("/sysclient")?>">更新联系结果</a></h3>
			  	<div id="form_box">       
			      	<form class="form-horizontal" id="connectedit" method="post" enctype=”multipart/form-data”>				   

				      	<div class="modal-body">
					       	<div class="form-group">
						   		<label for="inputEmail3" class="col-sm-2 control-label">联系结果</label>
						    	<div class="col-sm-10">
						    		<textarea name="connect_result"  id="connect_result" style="width:60%"  placeholder="联系内容" class="form-control" rows="5"></textarea> 						      		
						   		</div>
						  	</div>
				      	</div>
				      	<input name="connect_id"  type="hidden"  id="connect_id" value="<?php echo $connect_id;?>">

					    <div class="modal-footer">
					        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="javascript:history.back(-1);">关闭</button>
					        <button type="button" class="btn btn-primary" onclick="updateconnect()">更新</button>
					    </div>
			      	</form>
				</div>
	        </div>
...
<script type="text/javascript">
	function updateconnect(){	
		$.post("/sysconnect/updateActive", 
			$("#connectedit").serialize(),
			function(data){			
				if (data.status==0) {
					alert(data.info);
					return ;
