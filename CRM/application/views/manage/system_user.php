    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header"><a href="<?php echo site_url("/sysuser")?>">员工列表</a></h3>
          <div class="system_advert_nav">	
          	  <div>
          	  		<a href="/sysuser/add"><button type="button" class="btn btn-success">新增员工</button></a>
          	  </div>
		  ...
		  <div>
					...
					<?php if($page_totle==1){ ?>
								已是最后一页
					<?php } elseif($page<=1){ ?>
						<a href="/sysuser/index/<?php echo $page+1; ?>">下一页</a>&nbsp; 已到达第一页
					<?php } elseif($page>=$page_totle) {?>
						<a href="/sysuser/index/<?php echo $page-1; ?>">上一页</a> &nbsp;已到达最后一页
					
					<?php }else{ ?>
						<a href="/sysuser/index/<?php echo $page-1; ?>">上一页</a>&nbsp;&nbsp;<a href="/sysuser/index/<?php echo $page+1; ?>">下一页</a>
					<?php } ?>
