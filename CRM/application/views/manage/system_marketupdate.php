    ...
    <div class="container-fluid">
		...
		<?php $this->load->view('manage/menu');?>
	        ...
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	          	<h3 class="page-header"><a href="<?php echo site_url("/sysuser")?>">修改渠道</a></h3>
			  	<div id="form_box">       
			      	<form class="form-horizontal" id="marketedit" method="post" enctype=”multipart/form-data”>
				      	<div class="modal-body">
					       	<div class="form-group">
						    	...
						    	<div class="col-sm-10">
						      		<input name="name"  type="text" class="form-control" id="name" placeholder="渠道名称" value="<?php echo $market_name;?>">
						      		<input name="market_id"  type="hidden"  id="market_id" value="<?php echo $id;?>">
						   		</div>
						  	</div>				      	</div>
					    <div class="modal-footer">
					        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="javascript:history.back(-1);">关闭</button>
					        <button type="button" class="btn btn-primary" onclick="updatemarket()">修改</button>
					    </div>
			      	</form>
				</div>
	        </div>
