<?php
	...
	class CheckCode { 
		...
		**/ 
		...
		function __construct ($len=5,$im_width='',$im_height=34) { 
		...
		**/ 
		function create () { 
			...
			for($i = 0; $i < $this->len; $i++){ 
				...
				//imagettftext($this->im, 22, 0, $x, $this->y, $this->randcolor, $fontfile, substr($this->randnum, $i ,1));
