...
//		       console.log(labels);
			...
			chartParam.subtitle.text = countParam.sDate + "---" + countParam.eDate + "  密度：" + countParam.density;
			chartParam.tip.listeners.parseText = function(tip,name,value,text,i){
													var lab = labels[i];
													if(countParam.density == "day"){
														lab = lab + "日";
													}else if(countParam.density == "week"){
														lab = lab + "周";
													}else if(countParam.density == "month"){
														lab = lab + "月";
													}
...
function changeCountParam(){
	...
	countParam.density=$("#countDensity").val();
	countSeeker();
}
